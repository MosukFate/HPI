...
class VisualProjectionLayer(nn.Module):
    ...
    """
    def __init__(self, act=nn.Tanh(), hidden_layer=False, cosine=True, hidden_embed_dim=None, dino_embed_dim=1024, clip_embed_dim=768):
    ...
    def from_config(cls, config):
        ...
        model = cls(
            ...
            clip_embed_dim=config.get('clip_embed_dim', 768)
...
class ProjectionLayer(nn.Module):
    ...
    """
    def __init__(self, act=nn.Tanh(), hidden_layer=False, cosine=True, dino_embed_dim=1024, clip_embed_dim=768, num_attn_head=16, weight_attn_heads=None,
...
class CLIPLastLayer(nn.Module):
    def __init__(self,  act=nn.Tanh(), hidden_layer=False, cosine=True, dino_embed_dim=1024, clip_embed_dim=768, weight_attn_heads=None, alignment_strategy='max_score', clip_model='ViT-B/16', text_input_mask=None, projection_weights=None):
        import clip
        super().__init__()
